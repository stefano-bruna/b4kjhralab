          ...
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : patentEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="nameLabel" for="patent-name">
                    <Translate contentKey="b4KjhralabApp.patent.name">Name</Translate>
                  </Label>
                  <AvField id="patent-name" type="text" name="name" />
                </AvGroup>
                <AvGroup>
                  <Label id="descriptionLabel" for="patent-description">
                    <Translate contentKey="b4KjhralabApp.patent.description">Description</Translate>
                  </Label>
                  <AvField id="patent-description" type="text" name="description" />
                </AvGroup>
                <AvGroup>
