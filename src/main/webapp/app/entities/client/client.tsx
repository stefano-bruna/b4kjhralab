    ...
    return (
      <div>
        <h2 id="client-heading">
          <Translate contentKey="b4KjhralabApp.client.home.title">Clients</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="b4KjhralabApp.client.home.createLabel">Create a new Client</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {clientList && clientList.length > 0 ? (
            ...
            <div className="alert alert-warning">
              <Translate contentKey="b4KjhralabApp.client.home.notFound">No Clients found</Translate>
            </div>
          )}
        </div>
      </div>
