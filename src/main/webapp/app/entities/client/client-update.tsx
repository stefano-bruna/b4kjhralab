    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="b4KjhralabApp.client.home.createOrEditLabel">
              <Translate contentKey="b4KjhralabApp.client.home.createOrEditLabel">Create or edit a Client</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : clientEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="uidLabel" for="client-uid">
                    <Translate contentKey="b4KjhralabApp.client.uid">Uid</Translate>
                  </Label>
                  <AvField id="client-uid" type="text" name="uid" />
                </AvGroup>
                <AvGroup>
                ...
                <AvGroup>
                  <Label id="fiscalCodeLabel" for="client-fiscalCode">
                    <Translate contentKey="b4KjhralabApp.client.fiscalCode">Fiscal Code</Translate>
                  </Label>
                  <AvField id="client-fiscalCode" type="text" name="fiscalCode" />
                </AvGroup>
                <AvGroup>
                  <Label id="vatLabel" for="client-vat">
                    <Translate contentKey="b4KjhralabApp.client.vat">Vat</Translate>
                  </Label>
                  <AvField id="client-vat" type="text" name="vat" />
                </AvGroup>
