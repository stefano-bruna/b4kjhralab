...
import eu.bugnion.config.audit.AuditEventConverter;
import eu.bugnion.domain.PersistentAuditEvent;
...
import static eu.bugnion.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
