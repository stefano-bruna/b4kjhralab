...
import eu.bugnion.domain.Client;
import eu.bugnion.repository.ClientRepository;
...
public class ClientResourceIT {
    ...
    public void createClient() throws Exception {
        ...
        assertThat(testClient.getUid()).isEqualTo(DEFAULT_UID);
    ...
    public void updateClient() throws Exception {
        ...
        Client testClient = clientList.get(clientList.size() - 1);
        assertThat(testClient.getUid()).isEqualTo(UPDATED_UID);
